...
const HeadsDataContext: React.Context<HeadsDataService> = React.createContext(
  {} as HeadsDataService,
);
...
export const useHeadsDataContext = () => {
  ...
  if (!context) {
    throw new Error(
      "useHeadsDataContext must be used within a HeadsDataProvider",
    );
  }
  return context;
};

export const HeadsDataProvider: React.FC<any> = ({ children }) => {
