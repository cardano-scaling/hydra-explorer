...
const MemberCommitDetails: React.FC<MemberCommitDetailsProps> = ({
  member,
  onClose,
}) => {
  useEffect(() => {
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-xl relative">
        ...
        <div className="border p-4 col-span-2">
          <table className="w-full">
            ...
            <tbody>
              {member.commits &&
                Object.entries(member.commits).map(([txIn, commit], index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="truncate text-center border px-4 py-2">
                        <a
                          href={explorer.address(commit.address)}
                          target="_blank"
                          className="text-blue-300 hover:text-blue-500"
                        >
                          {commit.address}
