...
export const useStore = create<StoreState>((set) => ({
    ...
    // Actions
    updateNetwork: (magic: number) => set({ currentNetworkMagic: magic, headsLoading: true, ticksLoading: true, heads: [], ticks: [], pageIndex: 1 }),
    ...
    setHeads: (heads: HeadState[]) => set({ heads, headsLoading: false, headsError: null }),
